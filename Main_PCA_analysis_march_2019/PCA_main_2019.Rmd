...
for(i in 1:length(axis_trees[[1]]$tip.label)){
 ...
 plot_repo[i] <- mean(pop_data[pop_data$species ==  axis_trees[[1]]$tip.label[i] ,"mean_repo_rate_stable_state"])
...
#plotTree.wBars(tree = axis_trees[[1]], x = plot_sd, scale= 500, type="fan", cex = 0.2, tip.labels = T, fsize=0.37, width = 12)
#dev.off()

#pdf("phylobar_genT.pdf")
#plotTree.wBars(tree = axis_trees[[1]], x = plot_T, scale= 0.8, type="fan", cex = 0.2, tip.labels = T, fsize=0.37, width = 12)
#dev.off()

#pdf("phylobar_repo.pdf")
#plotTree.wBars(tree = axis_trees[[1]], x = plot_repo, scale= 30, type="fan", cex = 0.2, tip.labels = T, fsize=0.37, width = 12)
#dev.off()
